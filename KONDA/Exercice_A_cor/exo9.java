...
public class exo9 { /* Nom de la classe */
    ...
    public static void main(String[] args) { /* Toujours le mettre pour tester votre code */
        ...
        String firstname, lastname, email, password, confirmpassword, login; // Déclaration d'une variable a de Type
                                                                             // Texte */
        ...
        if (!password.equals(confirmpassword)) { // Vérifier si les mots de passes ne sont pas identiques
            ...
            System.out.println("Merci " + firstname + " " + lastname
                    + ", votre inscription a bien été effectuée, vous recevrez un mail de confirmation à l'adresse : "
                    + email); /* Afficher votre instruction */
            ...
            // des if dans un if c'est bien mais c'est pas PRO ! la prochaine fois on verra
            // avec les méthodes

            if (confirmpassword.equals(password) && login.equals(email)) { /*
                                                                            * Vérifier si le mot de passe et le login
                                                                            * sont équivalent au compte créé
                                                                            */
