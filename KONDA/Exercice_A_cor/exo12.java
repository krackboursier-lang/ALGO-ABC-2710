...
public class exo12 { /* ATTENTION LA CLASSE DOIT AVOIR LE MÊME NOM QUE LE FICHIER ! */
    ...
    public static void main(String[] args) { /* Toujours le mettre pour tester votre code */
        ...
        pricereduc = price * (1 - reduction / 100.0);// Attention mettre 100.0 pour définir le résulat en décimal sans
                                                     // arrondir

        System.out.println("Votre prix après réduction :" + pricereduc + " euros");

        System.out.println("Votre prix de " + price + " euros après une réduction de " + reduction + "% vaut "
                + pricereduc + " euros");
