public class AppFraction {
    public static void main(String[] args) {
        ...
        Ecran.afficheMessage("\n" + gras + bleu + "----------------------TEST DES CONSTRUCTEURS-------------------------" + reset, bleu);
        ...
        Ecran.afficheMessage("\n" + gras + bleu + "---------------------TESTS POUR LES OPÉRATEURS RELATIONNELS--------" + reset, bleu);
        ...
        Ecran.afficheMessage("\n" + gras + bleu + "---------------------TESTS POUR L'ÉGALITÉ--------" + reset, bleu);
        ...
        Ecran.afficheMessage("\n" + gras + bleu + "---------------------TESTS POUR LES OPÉRATIONS ARITHMÉTIQUES--------" + reset, bleu);
