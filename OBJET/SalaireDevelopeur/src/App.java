...
public class App {
    ...
    System.out.println("---------<< Affichage de la moyenne de l'échantillon de salaire des métiers de l'informatique>>---------------");
    double moyenne= objetStat.calculerMoyenne();
    System.out.println("salaire moyen de l'echantillon:" + moyenne+ " euros");

     System.out.println("---------<< Affichage de l'ecart type l'échantillon de salaire des métiers de l'informatique>>---------------");
     double ecart= objetStat.calculerEcartType();
     System.out.println("ecart type à moyenne + ou - :"+ ecart+ "Euros");

     
     System.out.println("---------<< Affichage de la valeur mediane de l'échantillon de salaire des métiers de l'informatique>>---------------");
